...
pub const Program = enum(UInt) {
    ...
    pub const uniform2ui = gl.programUniform2ui;
    pub const uniform4i = gl.programUniform4i;
    pub const uniform4ui = gl.programUniform4ui;
    ...
    pub const uniform1d = gl.programUniform1d;
    pub const uniform2d = gl.programUniform2d;
    pub const uniform3d = gl.programUniform3d;
    pub const uniform4d = gl.programUniform4d;
    pub const uniformMatrix2 = gl.programUniformMatrix2;
    pub const uniformMatrix3 = gl.programUniformMatrix3;
